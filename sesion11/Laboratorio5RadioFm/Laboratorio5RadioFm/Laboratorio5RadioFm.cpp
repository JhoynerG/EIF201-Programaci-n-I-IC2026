...
int main() {
    ...
    cout << "\nMODULO A: HistorialDoble" << endl;
    {
        ...
        h.insertarAntesDe("jazz3", "bosal1");
    ...
    cout << "\nMODULO B: RotacionCircular" << endl;
    {
        ...
        cout << "\n--- Probando Estadisticas y Contador ---" << endl;
        ...
        cout << "Simulando 5 turnos adicionales..." << endl;
        r.simularTurnos(5);

        r.imprimirEstadisticas();

        cout << "El locutor mas activo es: " << r.locutorMasActivo() << endl;
    }
